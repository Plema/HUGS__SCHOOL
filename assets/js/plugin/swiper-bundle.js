  ...
  function T(e, t) {
    ...
    return (
      r.WebKitCSSMatrix
        ...
        : (i = (a = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,'))
            .toString()
            .split(',')),
  ...
  var $ = {
    ...
    L = {
      attach: function (e, t) {
        ...
        a.observe(e, { attributes: void 0 === t.attributes || t.attributes, childList: void 0 === t.childList || t.childList, characterData: void 0 === t.characterData || t.characterData }),
              ...
              if (
                ...
                f > 0 && i.currentTranslate > this.minTranslate()
                  ...
                  : f < 0 &&
                    ...
                    ((v = !1), s.resistance && (i.currentTranslate = this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - f, g))),
        ...
        updateSlides: function () {
          ...
          if (void 0 !== s) {
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ('row' === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  ...
                  ;(I = (O = G - (A = Math.floor(G / N)) * N + D * t.slidesPerGroup) + (A * T) / z),
                    L.css({ '-webkit-box-ordinal-group': I, '-moz-box-ordinal-group': I, '-ms-flex-order': I, '-webkit-order': I, order: I })
                } else
            ...
            if (
              (0 === p.length && (p = [0]),
              0 !== t.spaceBetween &&
                (this.isHorizontal() ? (a ? d.filter(f).css({ marginLeft: y + 'px' }) : d.filter(f).css({ marginRight: y + 'px' })) : d.filter(f).css({ marginBottom: y + 'px' })),
          ...
          if (n && (!n || 0 !== Object.keys(n).length)) {
            ...
            if (l && this.currentBreakpoint !== l) {
              ...
              h && !p
                ...
                : !h &&
                  p &&
                  (r.addClass(a.containerModifierClass + 'multirow'), 'column' === d.slidesPerColumnFill && r.addClass(a.containerModifierClass + 'multirow-column'), this.emitContainerClasses())
  ...
  var U = {
      ...
      handle: function (e) {
        ...
        if ((s.invert && (r = -r), i.params.freeMode)) {
          ...
          if (
            (b.push(y), T ? (y.direction !== T.direction || y.delta > T.delta || y.time > T.time + 150) && i.mousewheel.animateSlider(y) : i.mousewheel.animateSlider(y), i.mousewheel.releaseScroll(y))
          )
            return !0
        }
        ...
        if (this.params.history) {
          ...
          ;(t.initialized = !0),
            ...
            (t.paths.key || t.paths.value) &&
              (t.scrollToSlide(0, t.paths.value, this.params.runCallbacksOnInit), this.params.history.replaceState || e.addEventListener('popstate', this.history.setHistoryPopState))
        }
      },
      destroy: function () {
        var e = l()
